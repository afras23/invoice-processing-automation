...
from app.services.validation_service import requires_approval, validate_extracted, validate_invoice
...
def test_requires_approval_above_threshold(monkeypatch):
    monkeypatch.setattr("app.services.validation_service.settings.approval_threshold", 500.0)
...
# ── validate_invoice (rich model, used by integrations) ───────────────────────
